...
module.exports = class Router
	constructor: (webRouter, apiRouter)->
		...
		webRouter.get  '/project', AuthenticationController.requireLogin(), SubscriptionMiddlewear.requireTeacherSubscription, AnalyticsMiddlewear.injectIntercomDetails, SubscriptionMiddlewear.loadFreeTrialInfo, ProjectController.projectListPage
